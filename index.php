...
if (!$conexion) {
    error_log("Database connection failed: " . $conexion->errorInfo()); // Log the error
        ...
        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
            ...
            <div class="slider-container" style="display: flex; justify-content: center; padding: 20px;">
                <div class="slider-item" style="width: 83%; padding: 0; border-radius: 55px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
                    ...
                    <img src="assets/img/slider/<?php echo htmlspecialchars($item['imagen'], ENT_QUOTES, 'UTF-8'); ?>" class="d-block w-100" style="height: 400px; object-fit: cover;" alt="<?php echo $item['titulo']; ?>">
                    <!-- Título y descripción debajo de la imagen -->
                    <div class="text-center mt-3">
                    <h5 style="color: black;"><?php echo htmlspecialchars($item['descripcion'], ENT_QUOTES, 'UTF-8'); ?></h5>
